...
class UserDAO:
    ...
    def validate_login(self, username, password):
        user = None
        try:
            # find() always return a full cursor rather than a single document
            user = self.users.find_one({"_id": username})
            print user
            print "validate: This space intentionally left blank."
        except:
    ...
    def add_user(self, username, password, email):
        ...
        try:
            ...
            print "add_user: This space intentionally left blank."
