...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        for post in cursor:
            ...
            if 'tags' not in post:
                post['tags'] = []  # fill it in if tags is empty
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            # When done, modify the line below to return the number of documents updated by your modification
            update_res = self.posts.update_one({"permalink": permalink},
